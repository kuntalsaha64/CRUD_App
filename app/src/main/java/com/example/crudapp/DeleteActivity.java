    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(num_rows==1){
                    Toast.makeText(DeleteActivity.this, "Row Deleted Successfully", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(DeleteActivity.this, "Error: Deletion Failed", Toast.LENGTH_SHORT).show();
                }
