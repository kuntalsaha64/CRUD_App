    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int status=userDbHelper.updateData(db,updateName.getText().toString(),updateEmail.getText().toString(),updatePhone.getText().toString());
                if(status==1){
                    Toast.makeText(UpdateActivity.this, "Updated Successfully", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(UpdateActivity.this, "Error:Update Failed", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
