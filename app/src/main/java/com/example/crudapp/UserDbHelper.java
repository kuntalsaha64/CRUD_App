...
public class UserDbHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_QUERY ="CREATE TABLE "+ TABLE_NAME + "("+FIRST_COL+" text,"+SECOND_COL+" text,"+THIRD_COL+" text)";
    ...
    public Cursor searchData(SQLiteDatabase db, String name) {
        Cursor cursor = db.rawQuery("SELECT * FROM " + TABLE_NAME + " WHERE " + FIRST_COL + " LIKE " + "'"+name + "'", null);
        return cursor;
    }
